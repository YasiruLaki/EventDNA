  ...
  <div class="dashboard-shell">
    <main class="dashboard-content">
      <section class="hero-row hero-header" style="margin-bottom: 2rem;">
        <div class="hero-copy">
          <h1 class="page-title">Good Evening, Hanan!</h1>
        ...
        <article class="stat-card"
          ...
          <div>
            ...
            <div style="height: 8px; background: #e2e8f0; border-radius: 999px; overflow: hidden; display: flex;">
              <div style="width: 79%; background: var(--primary); border-radius: 999px;"></div>
            </div>
          </div>
          ...
          <table style="width: 100%; border-collapse: collapse; text-align: left;">
            ...
            <tbody style="font-size: 0.95rem; color: var(--secondary);">
              <tr style="border-bottom: 1px solid rgba(226, 232, 240, 0.9);">
                <td style="padding: 1.25rem 1.5rem; font-weight: 600;">AI Innovation Summit</td>
