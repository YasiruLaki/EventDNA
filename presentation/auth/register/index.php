...
<head>
    ...
    <title>Create Account - EventDNA</title>
...
<body>
    <div class="split-layout">
        <div class="left-section">
            ...
            <p class="hero-description">
                Connect, collaborate, and grow with EventDNA—an intelligent platform that makes professional networking at events smarter, easier, and more meaningful.
            </p>
        </div>
                ...
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="email" id="email" name="email" placeholder="name@company.com" required value="<?php echo isset($_POST['email']) ? htmlspecialchars($_POST['email']) : ''; ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group" style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 1.5rem;">
                        ...
                        <label for="terms" style="margin: 0; font-weight: 500; font-size: 0.85rem; color: var(--secondary);">I agree to the <a href="#" style="color: inherit; text-decoration: underline;">Terms of Service</a> and <a href="#" style="color: inherit; text-decoration: underline;">Privacy Policy</a></label>
                    </div>
    ...
    <script>
        ...
        if (role) {
            ...
            if (loginLink) loginLink.href = `../login/index.php?role=${role}`;
        }
    </script>
</body>
</html>
